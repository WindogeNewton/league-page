/*   STEP 1   */
export const leagueID = "885583878981775360"; // your league ID
export const leagueName = "The Mental Erections"; // your league name
...
export const managers = [
     {
       ...
       "bio": "Sure",
       "photo": "/managers/matthewn.jpg", // square ratio recommended (no larger than 500x500)
       ...
       "favoritePlayer": 19852, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
       "valuePosition": "LB", // (optional) Favorite position (QB, WR, RB, TE, etc.)
       "rookieOrVets": "Vets", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
       "Win": "Your fantasy team's philosophy",
